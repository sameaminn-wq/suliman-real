...
export default function LandingPage() {
  // رقم الواتساب الخاص بك بالتنسيق الدولي الصحيح للرابط
  ...
  return (
    <div className="bg-white">
      ...
      {/* 4. قسم "دعنا نتحدث" - تواصل واتساب مباشر */}
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto bg-[#0F172A] rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden">
          ...
          <p className="text-gray-400 mb-12 text-lg relative z-10">تحدث معنا مباشرة عبر الواتساب، وسيقوم مستشارك العقاري بالرد عليك فوراً.</p>
